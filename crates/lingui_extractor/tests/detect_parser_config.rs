...
fn tsx_file_no_user_config() {
    ...
    assert_eq!(result, Syntax::Typescript(TsSyntax { tsx: true, ..Default::default() }));
}

#[test]
fn jsx_file_no_user_config() {
    let result = detect_parser_config("component.jsx", None);
    assert_eq!(result, Syntax::Es(EsSyntax { jsx: true, ..Default::default() }));
}

#[test]
fn ts_file_no_user_config() {
    let result = detect_parser_config("utils.ts", None);
    assert_eq!(result, Syntax::Typescript(TsSyntax { tsx: false, ..Default::default() }));
}
...
fn js_file_no_user_config() {
    ...
    assert_eq!(result, Syntax::Es(EsSyntax { jsx: false, ..Default::default() }));
}
...
fn user_jsx_true_on_js_file() {
    let user = Syntax::Es(EsSyntax { jsx: true, ..Default::default() });
...
fn user_jsx_false_on_jsx_file_gets_jsx_from_detection() {
    let user = Syntax::Es(EsSyntax { jsx: false, ..Default::default() });
...
fn user_tsx_false_on_tsx_file_gets_tsx_from_detection() {
    let user = Syntax::Typescript(TsSyntax { tsx: false, ..Default::default() });
...
fn user_decorators_preserved_on_js_file() {
    let user = Syntax::Es(EsSyntax { decorators: true, ..Default::default() });
    let result = detect_parser_config("app.js", Some(user));
    assert_eq!(result, Syntax::Es(EsSyntax { decorators: true, jsx: false, ..Default::default() }));
}

#[test]
fn user_decorators_preserved_on_ts_file() {
    let user = Syntax::Typescript(TsSyntax { decorators: true, ..Default::default() });
    let result = detect_parser_config("app.ts", Some(user));
    assert_eq!(result, Syntax::Typescript(TsSyntax { decorators: true, tsx: false, ..Default::default() }));
}

#[test]
fn user_tsx_true_on_ts_file_stays_true() {
    let user = Syntax::Typescript(TsSyntax { tsx: true, ..Default::default() });
